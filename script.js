...
window.addEventListener("load", function (e) {
        ...
        operationBtnParent.addEventListener("click", (e)=> {
                ...
                operationBtn.forEach((btn)=> btn.classList.remove("btn-active"));

                operationContent.forEach((content)=> content.classList.remove("operations-content-active"));

                // adding class  //////////

                clicked.classList.add("btn-active");
                const activeContent=document.querySelector(`.operations-content-${clicked.dataset.btn}`);
...
// testimonial section
 const slider=function () {
    ...
    const activateDot=function (slide) {
        ...
        const dde=document .querySelector(`.dots-dot[data-slide="${slide}"]`) .classList.add("dots-dot--active");
    }
    ...
    document.addEventListener("keydown", function (e) {
            if (e.key==="ArrowRight") nextMovement();
            if (e.key==="ArrowLeft") prevMovement();
        });
